        ...
        <section id="checkout" className="py-20 md:py-32 relative overflow-hidden bg-zinc-950">
            ...
            <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
                ...
                >
                    ...
                    <div className="inline-flex justify-center items-center px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary font-semibold text-sm mb-6 relative z-10">
                    ...
                    <button
                        ...
                        className="w-full md:w-auto inline-flex items-center justify-center gap-2 h-16 px-10 rounded-xl bg-primary hover:bg-primary text-zinc-950 text-lg font-bold transition-all hover:scale-105 active:scale-95 shadow-[0_0_30px_rgba(251,191,36,0.2)] hover:shadow-[0_0_40px_rgba(251,191,36,0.4)] relative z-10"
                    >
            ...
            <footer className="mt-32 border-t border-zinc-900 py-12 relative z-10">
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
                    <div className="flex items-center gap-2">
                        <div className="w-6 h-6 rounded bg-gradient-to-br from-primary to-primary flex items-center justify-center">
