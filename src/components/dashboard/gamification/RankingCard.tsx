    ...
    return (
        <div className="glass-panel p-6 rounded-2xl flex flex-col items-center justify-center relative overflow-hidden h-full min-h-[300px]">
            ...
            <div className="text-center flex flex-col items-center justify-center flex-1">
                ...
                <div className="text-[80px] leading-none font-black text-transparent bg-clip-text bg-gradient-to-b from-primary to-primary drop-shadow-lg">
                    7%
                </div>

                <p className="text-primary font-bold mb-6">dos alunos que mais estudam</p>

                <p className="text-zinc-500 text-xs max-w-[200px]">
                    em toda a plataforma Real Estudo.
                </p>
            </div>
